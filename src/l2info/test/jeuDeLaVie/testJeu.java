...
public class testJeu {
	...
	public void testCalculer() {
		...
		org.junit.Assert.assertEquals(Arrays.asList(new Cellule(2, 2)),
				jeu.calculer(listeCel, Jeu.MONDE_NORMAL));
	}
	...
	public void testEvaluerOscillateur() {
		...
		org.junit.Assert.assertEquals(Jeu.OSCILLATEUR,
	...
	public void testEvaluerStable() {
		...
		org.junit.Assert.assertEquals(Jeu.STABLE,
				jeu.evaluer(10, Jeu.MONDE_NORMAL, false));
	}
	...
	public void testEvaluerMort() {
		...
		jeu.ajouterCellule(new Cellule(0, 0));
		jeu.ajouterCellule(new Cellule(1, 0));
		org.junit.Assert.assertEquals(Jeu.MORT,
				jeu.evaluer(10, Jeu.MONDE_NORMAL, false));
	}
	...
	public void testEvaluerVaisseau() {
		...
		jeu.ajouterCellule(new Cellule(2, 2));
		org.junit.Assert.assertEquals(Jeu.VAISSEAU,
				jeu.evaluer(10, Jeu.MONDE_NORMAL, true));
	}
	...
	public void testEvaluerMondeFrontiere() {
		...
		jeu.ajouterCellule(new Cellule(0, 2));
		org.junit.Assert.assertEquals(Jeu.MORT,
				jeu.evaluer(10, Jeu.MONDE_FRONTIERES, false));
	}
	...
	public void testEvaluerCirculaire() {
		...
		org.junit.Assert.assertEquals(Jeu.OSCILLATEUR,
				jeu.evaluer(10, Jeu.MONDE_CIRCULAIRE, false));
	}
	...
	public void testHtml() throws IOException {
		...
		org.junit.Assert
		.assertEquals(
				"<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\"\"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\"><html><head><title>Resultats Jeu de la vie en monde NORMAL </title></head><body> <table border=\"1\"> <tr><th>Nom</th><th>type</th><th>Taille queue</th><th>Periode</th></tr><tr><td>test</td><td>Mort</td><td>3</td><td>1</td></tr><td>test2</td><td>Mort</td><td>1</td><td>1</td></tr></table> </html></body>"
,				Jeu.toFullHTML(jeux,"NORMAL").toString());
	}
