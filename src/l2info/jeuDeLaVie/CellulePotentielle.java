...
/**
 * Classe definissant les Cellules adjacante aux cellules vivante, ayant donc
 * une chance de devenir vivante à la generation suivante.
 * 
 * @author Ten
 * 
 */
public class CellulePotentielle extends Cellule {
	 ...
	 * 
	 * @return True si une Cellule est presente a cette position, false sinon.
	 */
	...
	public boolean equals(Object o) {
		if (this.x == ((CellulePotentielle) o).getX()
				&& this.y == ((CellulePotentielle) o).getY()) {
			return true;
		} else
			return false;
	}
	 ...
	 * 
	 * @return un entier correspondant au nombre actuel de voisins de la
	 *         cellulePotentielle
	 */
